...
class Iterator(object):
    ...
    def _flow_index(self, pos_n, neg_n, pos_batch_size, neg_batch_size, shuffle=False, seed=None):
        ...
        while 1:
            ...
            output = np.concatenate((pos_index_array[current_pos_index: current_pos_index + current_pos_batch_size],
                                     neg_index_array[current_neg_index: current_neg_index + current_neg_batch_size]),
                                    axis=0)
...
class ImageDataGeneratorV2(object):
    ...
    # flow_from_directory('flickr','trainP_new.json', 'trainN.json', output_type='hyperface', pos_batch_size=64, neg_batch_size=64)
